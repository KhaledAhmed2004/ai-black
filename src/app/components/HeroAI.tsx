...
//         {/* Center circular glow behind headline */}
//         <div
//           aria-hidden="true"
...
//           }}
//         >
//           {/* Inner black circle for hollow feel */}
//           <div
//             style={{
//               position: "absolute",
//               top: "50%",
...
//               height: "200px",
//               borderRadius: "999px",
//               background: "radial-gradient(circle, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 60%, rgba(0,0,0,0.95) 80%, rgba(0,0,0,0.85) 100%)",
//               opacity: 1,
//               filter: "blur(6px)",
//               boxShadow: "inset 0 0 40px rgba(0,0,0,1), 0 0 30px rgba(0,0,0,0.8)",
//             }}
//           />
//         </div>
  ...
  return (
    <section className="relative bg-black text-white py-16 md:py-24 lg:py-32 overflow-hidden">
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 -translate-x-[290px] flex-shrink-0"
          style={{
            top: "-80px",
            width: "302px",
            height: "302px",
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 -translate-x-[-80px] flex-shrink-0"
          style={{
            top: "-10px",
            width: "302px",
            height: "302px",
