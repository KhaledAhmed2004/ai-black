...
export default function TestimonialCarousel({ testimonials }: Props) {
  ...
  const mapStyle = (pos: number) => {
    ...
    const baseX = clamped === -2 ? -380 : clamped === -1 ? -220 : clamped === 0 ? 0 : clamped === 1 ? 220 : 380;
    const scale = clamped === 0 ? 1 : clamped === -1 || clamped === 1 ? 0.95 : 0.9;
    const opacity = clamped === 0 ? 1 : clamped === -1 || clamped === 1 ? 0.75 : 0.4;
